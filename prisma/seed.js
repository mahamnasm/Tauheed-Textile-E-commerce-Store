...
async function seed() {
  ...
  console.log('Created products, variants, images, inventory movements');

  // Seed 10 Authentic Pakistani Desi Reviews
  const allCreatedProducts = await prisma.product.findMany({ select: { id: true } });
  const DESI_REVIEWS_SEED = [
    {
      customerName: "Fatima Zahra",
      reviewerCity: "Lahore, DHA Phase 5",
      rating: 5,
      title: "Original Swiss Lawn & Breathtaking Embroidery!",
      comment: "Alhamdulillah parcel received! Fabric bohot soft aur breathable hai, embroidery ki finishing 100% picture jaisi hai. Highly recommended!",
    ...
    },
    {
      ...
      comment: "Karachi mein order karne ke 2 din baad hi courier rider aa gaya. COD payment easily ho gayi. Chiffon dupatta ka fall bohot zabardast hai.",
    ...
    },
    {
      ...
      comment: "Maine WhatsApp concierge pe tailor made stitching karwayi thi. Fit bilkul accurate aaya hai, koi alter karwane ki zaroorat nahi pari. Resham tilla work is so neat!",
    ...
    },
    {
      ...
      comment: "Dhone ke baad bhi rang bilkul dull nahi hua aur kapray me shrink nahi aayi. Original combed Egyptian cotton hai. 10/10 quality!",
      imageUrl: "/assets/prod-nafasat.jpg",
      isApproved: true,
      isFeatured: true,
    },
    {
      ...
      comment: "Bhai ki shadi k liye suit mangwaya tha. Dupatta aur daman pe embroidery bohat bariki se ki gayi hai. Sab rishtedaar tareef kar rahay thay.",
    ...
    },
    {
      ...
      comment: "EasyPaisa se advance payment ki thi, flat 5% off mil gaya aur receipt upload karne par foran confirmation message aa gaya. Customer service bohot polite hai.",
    ...
    },
    {
      ...
      comment: "Winter festive collection ka velvet suit order kiya tha. Shawl ka weight aur border work royal look deta hai. Peshawar mein 4 din mein deliver hua.",
      imageUrl: "/assets/prod-bridal.jpg",
      isApproved: true,
      isFeatured: true,
    },
    {
      ...
      comment: "Designer boutique se 25,000 ka suit lene ke bajaye Tauheed Textile se mangwaya. Fabric aur look same high-end designer wali hai. Will shop again!",
    ...
    },
    {
      ...
      comment: "Pure lawn shirt with embroidered neckline is so comfortable in intense heat. Dupatta lightweight hai aur sar pe easily tikta hai.",
      imageUrl: "/assets/prod-armani.jpg",
      isApproved: true,
      isFeatured: true,
    },
    {
      ...
      comment: "Peoples usually hesitate buying dresses online, but Tauheed Textile has won my complete trust. 100% authentic stuff as shown in video reels. JazakAllah!",
      imageUrl: "/assets/prod-nafasat.jpg",
      isApproved: true,
      isFeatured: true,
    },
  ...
  for (let i = 0; i < DESI_REVIEWS_SEED.length; i++) {
    const r = DESI_REVIEWS_SEED[i];
    const targetProd = allCreatedProducts[i % allCreatedProducts.length];
  ...
  console.log('Created 10 authentic Pakistani desi reviews');
