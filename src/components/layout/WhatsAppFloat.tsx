...
export default function WhatsAppFloat({ initialSettings }: WhatsAppFloatProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-40 bg-emerald-600 hover:bg-emerald-700 text-white p-3 sm:p-3.5 rounded-full shadow-2xl flex items-center gap-2 group transition-all duration-300 hover:scale-105 border-2 border-white"
    >
